...
gps = GPS(10, [2; 2]); % Arguments: frequency [Hz], std [m]

imu = IMU(100, [pi/180, pi/180, pi/180, pi/180, pi/180, pi/180], 5, [0,0,0]); % Arguments: frequency [Hz], std [rad]/[rad/s], ...

barometer = BAROMETER(10, 0.06); % Arguments: frequency [Hz], std [hPa]
